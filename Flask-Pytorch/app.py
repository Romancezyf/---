...
resnet = InceptionResnetV1(pretrained='vggface2', model_path='20180402-114759-vggface2.pt').eval().to(device)
dataset_path = r"dataset"
embeddings, labels = load_dataset(dataset_path, mtcnn, resnet, device=device)  # 提取给定图像的embedding，便于人脸检测的识别
